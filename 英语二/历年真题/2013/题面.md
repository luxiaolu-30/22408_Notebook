...
**Directions:** Read the following text and choose the most suitable subtitle from the A-G list for each numbered paragraph (41-45). There are two extra subtitles which you do not need to use. Mark your answers on ANSWER SHEET 1. (10 points)
...
**图表信息（原卷为柱状图 某高校学生兼职情况）：**

- 图表类型：柱状图，展示某高校各年级学生兼职比例
- 横轴：年级（大一、大二、大三、大四）；纵轴：兼职学生百分比
- 大一：67.77%
- 大二：71.13%（略有上升）
- 大三：71.93%（基本持平）
- 大四：88.24%（急剧上升）
- 核心趋势：大一至大三兼职比例缓慢增长，大四急剧攀升至近九成，整体上升
