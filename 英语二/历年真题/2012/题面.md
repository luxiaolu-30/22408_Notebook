...
In the Internet age, it is particularly easy to see the resentment that has always been hidden within American society. More difficult, in the moment, is discerning precisely how these lean times are affecting society's character. In many respects, this recession was no more severe than those of the 1970s, 1980s, or even the 1930s. Yet, now the social fabric seems more fragile. We will have to wait and see exactly how these hard times will reshape our social fabric. But they certainly will reshape it, and all the more so the longer they extend.
...
"The history of all hitherto existing society is the history of class struggles," wrote Marx and Engels in The Communist Manifesto. For them, history did nothing, it possessed no immense wealth nor waged battles: "It is man, real, living man who does all that." And history should be the story of the masses and their record of struggle. As such, it needed to appreciate the economic realities, the social contexts and power relations in which each epoch stood. For: "Men make their own history, but they do not make it just as they please; they do not make it under circumstances chosen by themselves, but under circumstances directly found, given and transmitted from the past."
...
**图表信息（原卷为表格 某公司员工工作满意度调查）：**

- 图表类型：表格，按年龄段分组统计工作满意度
- 行/列：三组年龄段（≤40岁、41–50岁、>50岁）× 三种态度（满意、不清楚、不满意）
- ≤40岁：满意 16.7%，不清楚 50.0%，不满意 33.3%
- 41–50岁：满意 0.0%，不清楚 36.0%，不满意 64.0%（满意度最低）
- >50岁：满意 40.0%，不清楚 50.0%，不满意 10.0%（满意度最高）
- 核心趋势：年龄越大工作满意度越高；41–50岁人群满意度最低、不满意率最高
